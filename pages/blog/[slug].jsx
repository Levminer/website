				...
				<div className="pb-32">
					<div className="container mx-auto rounded-xl bg-gray-800 p-8 md:max-w-4xl small:!w-full">
						...
						<div className="small:flex-wrap mt-5 flex gap-3">
							<a href="https://twitter.com/levminer92" className="button bg-popup-blue border-popup-blue hover:text-popup-blue gap-3 font-medium text-white" rel="noopener" target="_blank" aria-label="Twitter">
							...
							<a href="/blog" className="button gap-3 font-medium" aria-label="Other articles">
								<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
