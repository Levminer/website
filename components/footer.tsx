		...
		<>
			<footer className="bg-gray-900">
				<div className="mx-auto p-6">
						...
						<div className="mb-3 w-full">
							<div className="flex items-center justify-center gap-3">
								<a
									...
									aria-label="Twitter"
								>
									<svg role="img" className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
										<title>X</title>
								...
								<a
									...
									aria-label="GitHub"
								>
									<svg role="img" viewBox="0 0 24 24" className="h-8 w-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
					...
					<div>
						<h1 className="text-center text-2xl">Copyright © 2023 Lőrik Levente</h1>
					</div>
				</div>
			</footer>
		</>
