...
function level1() {
	...
	if (level_login == level_log && level_password == level_pas) {
		...
		counter++
		alert("Sikertelen bejelentkezés! (1.szint) (" + (20-counter) + " próbálkozás maradt)")
		document.getElementById("log").value = ""
		document.getElementById("pas").value = ""
		document.getElementById("pwr").value = ""
		document.getElementById("otp").value = ""
...
function level2() {
	...
	if (level_login == level_log && level_password == level_pas) {
		...
		counter++
		alert("Sikertelen bejelentkezés! (2.szint) (" + (15-counter) + " próbálkozás maradt)")
		document.getElementById("log").value = ""
		document.getElementById("pas").value = ""
		document.getElementById("pwr").value = ""
		document.getElementById("otp").value = ""
...
function level3() {
	...
	if (level_login == level_log && level_password == level_pas && level_passwordreminder == level_pwr) {
		...
		counter++
		alert("Sikertelen bejelentkezés! (1.szint) (" + (10-counter) + " próbálkozás maradt)")
		document.getElementById("log").value = ""
		document.getElementById("pas").value = ""
		document.getElementById("pwr").value = ""
		document.getElementById("otp").value = ""
...
function level4() {
	...
	if (
		...
		counter++
		alert("Sikertelen bejelentkezés! (1.szint) (" + (5-counter) + " próbálkozás maradt)")
		document.getElementById("log").value = ""
		document.getElementById("pas").value = ""
		document.getElementById("pwr").value = ""
		document.getElementById("otp").value = ""
